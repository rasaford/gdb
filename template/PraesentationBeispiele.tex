...
\mbox{\includegraphics[height=.5\paperheight, trim=0cm 14cm 0cm 0cm, clip=true]{../template/res/img/SternenhimmelHochkant.jpg}}%
\hspace{6.5mm}%
\mbox{\includegraphics[height=.5\paperheight, trim=0cm 14cm 0cm 0cm, clip=true]{../template/res/img/SternenhimmelHochkant.jpg}}
...
\begin{multicols}{2}
    ...
    Punkt 4
    \vfill\columnbreak
    \includegraphics[width=\columnwidth, height=.7\textheight]{../template/res/img/SternenhimmelHochkant.jpg}%
\end{multicols}
...
\includegraphics[width=\textwidth, height=.55\textheight]{../template/res/img/SternenhimmelQuer.jpg}%
...
\includegraphics[width=\paperwidth]{../template/res/img/SternenhimmelQuer.jpg}
\end{minipage}
...
\includegraphics[width=0.4\paperwidth]{../template/res/img/Motor.png}
\end{textblock*}

\begin{textblock*}{0.6\paperwidth}[1,1](\textwidth + \PraesentationSeitenrand, \textheight - \PraesentationSeitenrand)%
\includegraphics[width=0.6\paperwidth]{../template/res/img/Getriebe.png}
\end{textblock*}
...
\begin{minipage}[t][0cm]{\paperwidth}%
\hspace*{-\PraesentationSeitenrand}%
\includegraphics[width=\textwidth]{../template/res/img/SternenhimmelQuer.jpg}
\end{minipage}
...
\raggedleft%
\includegraphics[height=0.5\textheight]{../template/res/img/Motor.png}
\end{textblock*}
